...
export function ConversionDialog({ }: ConversionDialogProps) {
  ...
  const [youtubeOutputFormat, setYoutubeOutputFormat] = useState<'mp3' | 'wav'>('mp3');
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: 'mp3' | 'wav') => setYoutubeOutputFormat(value)}
              >
                <SelectTrigger>
            ...
            <Button 
              ...
              className="w-full"
            >
              {isDownloading ? "Converting..." : `Convert to ${youtubeOutputFormat.toUpperCase()}`}
            </Button>
