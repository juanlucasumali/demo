...
CREATE TABLE IF NOT EXISTS "public"."collabs" (
    ...
    "inviter_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "invitee_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "project_id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL
);

ALTER TABLE "public"."collabs" OWNER TO "postgres";

ALTER TABLE "public"."collabs" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."collabs_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."collabs"
    ADD CONSTRAINT "collabs_invintee_id_fkey" FOREIGN KEY ("invitee_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY "public"."collabs"
    ADD CONSTRAINT "collabs_inviter_id_fkey" FOREIGN KEY ("inviter_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY "public"."collabs"
    ADD CONSTRAINT "collabs_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Enable all for users based on inviter_id" ON "public"."collabs" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "inviter_id"));
...
CREATE POLICY "Enable read access for authenticated users only" ON "public"."collabs" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON TABLE "public"."collabs" TO "anon";
GRANT ALL ON TABLE "public"."collabs" TO "authenticated";
GRANT ALL ON TABLE "public"."collabs" TO "service_role";

GRANT ALL ON SEQUENCE "public"."collabs_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."collabs_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."collabs_id_seq" TO "service_role";
